...
from markdown import ( extract_markdown_images, extract_markdown_links, split_nodes_delimiter,
...
class TestMarkdown(unittest.TestCase):
    ...
    def test_extract_markdown_links2(self):
        matches = extract_markdown_links(
            "This is text with a links [to boot dev](https://www.boot.dev) and [google link](https://google.com)"
        )
        self.assertListEqual([("to boot dev", "https://www.boot.dev"), ("google link", "https://google.com")], matches)

    def test_extract_markdown_images_links(self):
        matches = extract_markdown_images(
            "This is text with a ![rick roll](https://i.imgur.com/aKaOqIh.gif)"
        )
        matches.extend(extract_markdown_links(
            "This is text with a links [google link](https://google.com)")
        )
        self.assertListEqual([("rick roll", "https://i.imgur.com/aKaOqIh.gif"), ("google link", "https://google.com")], matches)

class TestTextNodeSplitImageLink(unittest.TestCase):
